...
export const DEEPER_READING: Record<string, DocsLink[]> = {
  ...
  "from-install-to-a-governed-deny": [
    { href: "/docs/getting-started/quickstart", label: "Quickstart" },
    {
      href: "/docs/cookbook/24-egress-policy-language",
      label: "Cookbook: the egress policy language",
    },
  ],
  "what-is-a-policy-enforcement-plane": [
  ...
  "enforcement-plane-vs-api-gateway": [
    { href: "/docs/guides/EGRESS_POLICY", label: "Egress policy guide" },
    {
      href: "/docs/cookbook/23-harden-public-gateway",
      label: "Cookbook: harden a public gateway",
    },
  ],
  "deterministic-not-anomaly-based": [
    { href: "/docs/guides/EGRESS_POLICY", label: "Egress policy guide" },
  ...
  "costs-and-boundaries": [
    {
      href: "/docs/cookbook/13-production-checklist",
      label: "Cookbook: production checklist",
    },
    { href: "/docs/guides/DEPLOYMENT_PLAYBOOK", label: "Deployment playbook" },
  ],
  "more-than-one-hangar": [
    {
      href: "/docs/cookbook/25-multiple-replicas",
      label: "Cookbook: running multiple replicas",
    },
  ...
  "digest-pinning": [
    {
      href: "/docs/cookbook/18-tenant-digest-pins",
      label: "Cookbook: per-tenant digest pins",
    },
    {
      href: "/docs/cookbook/14-upgrade-1.3-digest-pinning",
      label: "Cookbook: adopting digest pinning",
    },
  ],
  "governance-observability": [
    { href: "/docs/guides/OBSERVABILITY", label: "Observability guide" },
    {
      href: "/docs/cookbook/07-observability-metrics",
      label: "Cookbook: metrics",
    },
  ],
  "the-governed-task-relay-flow": [
  ...
  "mid-flight-consent": [
    { href: "/docs/guides/GOVERNED_TASKS", label: "Governed tasks guide" },
    {
      href: "/docs/guides/APPROVAL_ADAPTERS",
      label: "Approval adapters guide",
    },
  ],
  "govern-an-async-task-end-to-end": [
    { href: "/docs/guides/GOVERNED_TASKS", label: "Governed tasks guide" },
