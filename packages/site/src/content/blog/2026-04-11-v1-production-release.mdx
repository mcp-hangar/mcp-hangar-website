...
> **Update (2026-05-17):** As of v1.3.0, MCP Hangar is fully MIT-licensed. The BSL dual-license model described above no longer applies. All features are unconditionally available under MIT. See the [announcement post](./2026-05-17-mcp-hangar-is-now-mit).
