...
The Helm chart now installs the `MCPEgressPolicy` CRD and grants the operator the RBAC to reconcile it, so the feature works from a plain `helm install`. See the [Egress Policy guide](/docs/guides/EGRESS_POLICY) to get started.
