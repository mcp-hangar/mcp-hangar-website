...
<Callout variant="preview">
  **Landing in 2.0.** Everything on this page describes the governed task relay
  on the **v2 preview** (`2.0.0rc1`, built on `mcp==2.0.0b2`). It is **not** in
...
building on [ADR-002](/docs/adr/ADR-002-event-sourcing) (the provenance chain) and
[ADR-004](/docs/adr/ADR-004-sep-1766-digest-pinning) (digest pinning). Everything is MIT and
self-hosted -- no SaaS.*
