...
The cloud dashboard is coming with fleet-wide cost dashboards, aggregated caller analytics, and managed SIEM pipelines. Join the [waitlist](https://mcp-hangar.io/waitlist) to be first.
