        ...
        <div className="min-h-screen bg-zinc-950 text-zinc-300">
            ...
            <main className="max-w-3xl mx-auto px-6 py-20">
                ...
                <div className="space-y-10 text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-zinc-100 mb-3">4. Waitlist</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-zinc-100 mb-3">5. Open-source software</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-zinc-100 mb-3">6. Disclaimer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-zinc-100 mb-3">7. Limitation of liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-lg font-semibold text-zinc-100 mb-3">8. Governing law</h2>
                        <p>
