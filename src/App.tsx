        ...
        <footer className="border-t border-zinc-800/50">
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-zinc-500">
            <div className="flex items-center gap-2">
              ...
              <span>mcp-hangar · MIT License</span>
            </div>
            <div className="flex items-center gap-6">
              <a href="https://github.com/mapyr/mcp-hangar" className="hover:text-emerald-400 transition-colors duration-300">GitHub</a>
              <a href="https://mapyr.github.io/mcp-hangar/" className="hover:text-emerald-400 transition-colors duration-300">Docs</a>
              <a href="https://pypi.org/project/mcp-hangar/" className="hover:text-emerald-400 transition-colors duration-300">PyPI</a>
            </div>
          </div>
        </footer>
      </div>
